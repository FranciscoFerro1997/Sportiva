...
/*	Conexion con = new Conexion();
	...
	public Gerente(String id, String nombre, String apellido, String dni, String email, String tel, int p, int s, String clave) {
	...
	public LinkedList<Gerente> traerUsuario(int id)  {
	    ...
	    try {
	        ...
	        while (result.next()) {
	            ...
	            usuarios.add(new Gerente(datos[0], datos[1], datos[2], datos[3], datos[4], datos[5], Integer.parseInt(datos[6]), Integer.parseInt(datos[7]), datos[8]));
	        }
